  ...
  const contactInfo = [
    {
      icon: Mail,
      title: "Email",
      value: "ebunosujoye@gmail.com", 
      href: "mailto:ebunosujoye@gmail.com"
    },
    {
      icon: Phone,
      title: "Phone",
      value: "+234 9028963407",
      href: "tel:+2349028963407"
    },
    {
      icon: MapPin,
      title: "Location",
  ...
  const socialLinks = [
    {
      icon: Github,
      name: "GitHub",
      url: "https://github.com/Osujoye",
      color: "hover:text-gray-600",
    },
    {
      icon: Linkedin,
      name: "LinkedIn", 
      url: "https://www.linkedin.com/in/ebunosujoye/",
