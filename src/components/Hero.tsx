          ...
          <div className="order-2 lg:order-1">
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl">
                ...
                data-driven insights using tools like React, Tailwind, R, and
                Excel. Passionate about clean code, clear visuals, and creative
                solutions.
              </p>

              <div className="flex flex-wrap gap-4">
                <Button onClick={scrollToContact}>Get In Touch with me</Button>
